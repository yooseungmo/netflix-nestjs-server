...
describe('MovieService', () => {
  ...
  describe('findRecent', () => {
    ...
    it('should fatch recent movies from the repository and cache them if not found in cache', async () => {
      const recentMovies = [
        {
          id: 1,
          title: 'blanc',
  ...
  describe('findAll', () => {
    ...
    it('should return a list of movies without user likes', async () => {
      ...
      const dto = { title: 'blanc' } as GetMoviesDto;
      const qb: any = {
      ...
      expect(qb.where).toHaveBeenCalledWith('movie.title Like :title', { title: '%blanc%' });
  ...
  describe('create', () => {
    ...
    let createMoiveGenreRelationMock: jest.SpyInstance;
    ...
    beforeEach(() => {
      ...
      createMoiveGenreRelationMock = jest.spyOn(movieService, 'createMovieGenreRelation');
    ...
    it('should create a movie successfully', async () => {
      ...
      createMoiveGenreRelationMock.mockResolvedValue(undefined);
      ...
      expect(createMoiveGenreRelationMock).toHaveBeenCalledWith(
        qr,
  ...
  describe('update', () => {
    ...
    it('should rollback transaction and rethrow error on fail', async () => {
      const updateMovieDto: UpdateMovieDto = {
        title: 'New blanc',
      };
